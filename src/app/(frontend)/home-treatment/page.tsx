      ...
      <main className="pt-20 min-h-screen relative overflow-hidden bg-gradient-to-b from-[#1a120b] via-[#0d0a07] to-black">
        ...
        <section className="relative z-10 py-8 px-4 md:py-20 md:px-5">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Kartu memanjang ke kanan, ditumpuk satu kolom */}
            {displayedTreatments.length > 0 && (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 p-3 md:p-5">
                    <div className="flex-1 min-w-0">
                      ...
                      <h3 className="font-playfair text-sm md:text-xl font-bold text-white leading-tight line-clamp-2 mt-0.5">
                        {treatment.name}
                      </h3>
                      <span className="block mt-1 text-sm md:text-base font-bold bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent">
                    ...
                    <Link
                      ...
                      target="_blank"
                      className="flex-shrink-0 inline-flex items-center justify-center gap-2 bg-gradient-to-r from-primary to-primary-light text-dark py-2 px-4 md:px-5 rounded-lg font-semibold text-xs md:text-sm hover:shadow-lg hover:shadow-primary/30 transition-all duration-300"
                    >
