// Daftar kabupaten/kota per provinsi (38 provinsi Indonesia).
// Key HARUS sama persis dengan nama provinsi di daftar PROVINCES.
export const KABUPATEN_BY_PROVINCE: Record<string, string[]> = {
  'Aceh': [
  ...
  'Sumatera Utara': [
    ...
    'Kabupaten Toba', 'Kota Binjai', 'Kota Gunungsitoli', 'Kota Medan', 'Kota Padangsidimpuan',
  ...
  'Maluku Utara': [
    ...
    'Kabupaten Halmahera Timur', 'Kabupaten Halmahera Utara', 'Kabupaten Kepulauan Sula', 'Kabupaten Pulau Morotai',
...
export function getKabupaten(province: string): string[] {
  return KABUPATEN_BY_PROVINCE[province] ?? [];
}
